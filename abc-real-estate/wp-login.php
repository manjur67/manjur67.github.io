<!DOCTYPE html>
	...
	<title>Log In &lsaquo; ABC Real State &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
		...
		&larr; Back to ABC Real State		</a></p>
			</div>
...
<script>
var _wpUtilSettings = {"ajax":{"url":"\/mywpsites\/realestatewps01\/wp-admin\/admin-ajax.php"}};
</script>
