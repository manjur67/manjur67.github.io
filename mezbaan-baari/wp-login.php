<!DOCTYPE html>
	...
	<title>Log In &lsaquo; Mezbaan Baari &#8212; WordPress</title>
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
		...
		&larr; Back to Mezbaan Baari		</a></p>
			</div>
...
<script>
var _wpUtilSettings = {"ajax":{"url":"\/mywpsites\/restaurantwps01\/wp-admin\/admin-ajax.php"}};
</script>
